    ...
    var t = function (e) {
      ...
      i = function (e, t, i) {
        (this.defaultMessages = t || {}),
          ...
          (this.REGEXP = { email: /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/, zip: /^\d{5}(-\d{4})?$/, phone: /^([0-9]( |-)?)?(\(?[0-9]{3}\)?|[0-9]{3})( |-)?([0-9]{3}( |-)?[0-9]{4}|[a-zA-Z0-9]{7})$/, password: /[^\w\d]*(([0-9]+.*[A-Za-z]+.*)|[A-Za-z]+.*([0-9]+.*))/, strengthPass: /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]/ }),
          (this.DEFAULT_REMOTE_ERROR = "Error"),
          (this.state = { tooltipsTimer: null }),
          this.setForm(document.querySelector(e));
      };
    (i.prototype = {
      defaultRules: { email: { required: !0, email: !0 }, name: { required: !0, minLength: 3, maxLength: 60 }, text: { required: !0, minLength: 5, maxLength: 300, fileTypes: "txt,doc,docx,pdf,xls,xlsx,jpg,jpeg,png,gif,tif,tiff,svg" }, password: { required: !0, password: !0, minLength: 4, maxLength: 8 }, zip: { required: !0, zip: !0 }, phone: { phone: !0, minLength: 5, maxLength: 20 } },
